...
//  Amity
//
//  Created by Jing Tang on 19/11/2014.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let googleMapsApiKey = "AIzaSyBuPir710ULzoC9zchrahtLTQN294suc6I"
    ...
    func sessionStateChanged(session:FBSession, state:FBSessionState, error:NSError?) {
        UserManager.instance.delegate?.faceBookSessionStateChanged(session, state: state, error: error)
    }
